    ...
    <div>
      <div className="p-3 shadow-lg rounded-2xl border border-x-firstColor border-y-orange-400">
        ...
        <div className="text-left">
          <button
            type="button"
            class="text-white bg-firstColor hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center my-5"
          >
            Show Details
            <svg
              aria-hidden="true"
